...
function Layout() {
  ...
  const isHome = path === '/';
  const isEleveSpace = path.startsWith('/eleve');
  const isEnseignantSpace =
    path.startsWith('/enseignant') ||
    path.startsWith('/activite/') ||
    path.startsWith('/lecon/') ||
    path.startsWith('/sequence/') ||
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-14">
            ...
            <div className="flex items-center gap-2">
              {!isHome && isEnseignantSpace && !isEleveSpace && (
                <>
                  <Link
