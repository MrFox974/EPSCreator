            ...
            <div className="flex items-center gap-3">
              ...
              {lecons.length > 1 && !isReordering && (
                <button
                  ...
                  className="bg-white/20 backdrop-blur-sm text-white px-4 py-3 rounded-xl font-semibold hover:bg-white/30 transition-all flex items-center gap-2 border border-white/30"
              ...
              {!isReordering && (
                <button
                  ...
                  className="bg-white/20 backdrop-blur-sm text-white px-6 py-3 rounded-xl font-semibold hover:bg-white/30 transition-all flex items-center gap-2 border border-white/30"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mb-8">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            ...
            {sequences.length === 0 && (
              ...
              >
                <div className="w-12 h-12 bg-slate-200 rounded-xl flex items-center justify-center mb-3 group-hover:bg-[#2e7d32] group-hover:text-white transition-all">
                  <svg className="w-6 h-6 text-slate-400 group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
                  </svg>
                </div>
                <span className="text-slate-500 font-medium group-hover:text-[#2e7d32]">Créer un projet de séquence</span>
              </button>
            )}
                ...
                <div className="p-5">
                  <div className="flex items-start justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h3 className="font-semibold text-slate-800 group-hover:text-[#2e7d32] transition-colors">
                  ...
                  <div className="mt-4 flex items-center justify-between">
                    ...
                    <span className="text-[#2e7d32] text-sm font-medium group-hover:translate-x-1 transition-transform flex items-center gap-1">
                      Ouvrir
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                      </svg>
