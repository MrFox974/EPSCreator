  ...
  return (
    <div className="min-h-[calc(100vh-3.5rem)] flex flex-col items-center justify-center px-4 bg-gradient-to-br from-slate-50 to-slate-100">
      <div className="max-w-lg text-center">
        ...
        <h1 className="text-2xl font-bold text-slate-800">Espace élève</h1>
        <p className="mt-3 text-slate-600">
          Cette partie sera disponible prochainement.
        </p>
        <Link
          to="/"
          className="inline-flex mt-8 px-6 py-3 rounded-xl font-semibold text-[#1e3a5f] bg-white border border-slate-200 shadow-sm hover:bg-slate-50 transition-colors"
        >
          Retour à l&apos;accueil
        </Link>
      </div>
